...
public static class MicrosoftTeamsHandlerTests
{
    ...
    public static void ContainsCallStartedEventToken_NoEventToken_ReturnsNull(string line)
    {
        var handler = GetHandler();
        Assert.Null(handler.ContainsCallStartedEventToken(line));
    }

    public static readonly TheoryData<string> _noCallStartedEventTokenData = new()
    {
        EventData3,
        EventData4,
        EventData5
    ...
    [Theory]
    [MemberData(nameof(_noCallStartedEventTokenData))]
    public static void ContainsCallStartedEventToken_NoCallStartedEventToken_ReturnsFalse(string line)
    {
        var handler = GetHandler();
        Assert.False(handler.ContainsCallStartedEventToken(line));
    }

    [Fact]
    public static void ContainsCallStartedEventToken_CallStartedEventToken_ReturnsTrue()
    {
        var handler = GetHandler();
