...
public class MicrosoftTeamsHandlerTests
{
    ...
    public static void LastAvailabilityFromLinesOfInterest_NoEventToken_ReturnsTrue()
    {
        ...
        Assert.True(MicrosoftTeamsHandler.LastAvailabilityFromLinesOfInterest(lines));
    }
    ...
    public static void LastAvailabilityFromLinesOfInterest_CallStart_ReturnsFalse()
    {
        ...
        Assert.False(MicrosoftTeamsHandler.LastAvailabilityFromLinesOfInterest(lines));
    }
